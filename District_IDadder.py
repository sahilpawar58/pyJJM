...
if 'features' in maharashtra_data:
    for maharashtra_feature in maharashtra_data['features']:
        ...
        # Add matched features with updated properties to combined features
        for matching_feature in matching_features:
            matching_properties = matching_feature.get('properties', {})
            matching_properties['District_ID'] = maharashtra_district_id
            combined_features.append(matching_feature)
...
with open('combined_output.geojson', 'w') as f:
